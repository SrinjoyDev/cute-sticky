...
<p align="center">
  ...
  A strip of dots on the right edge of your screen. Hover it, your notes fan out. Click one, it floats.
</p>

<p align="center">
  <img src="docs/screenshots/hero.png" width="820" alt="The tab on the right edge, the pile of cards dealt out beside it, and one open note">
</p>
...
- **Lightweight.** A Rust shell around WebView2. About 30 KB of JavaScript in total, a few megabytes on disk, and tens of megabytes of memory while idle.
...
You need [Node.js](https://nodejs.org) 22+, [Rust](https://rustup.rs) stable, and the Visual Studio Build Tools 2022 with the *Desktop development with C++* workload.
...
Three windows, all frameless and transparent, drawn with CSS:
